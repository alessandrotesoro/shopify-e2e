...
export const packVerifiedPackage = async (
	...
	expect(publishedPaths).toEqual(
		expect.arrayContaining([
			...
			"dist/playwright/fixtures.d.cts",
			"dist/playwright/public.cjs",
			"dist/playwright/public.d.cts",
			"dist/playwright/storefront.cjs",
			"dist/playwright/storefront.d.cts",
			"dist/playwright/type-like-human.cjs",
			"dist/playwright/type-like-human.d.cts",
			"dist/role-states/configured-origin.cjs",
			"dist/role-states/configured-origin.d.cts",
